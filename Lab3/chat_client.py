...
message = "public_key: %d %d private_key: %d %d" % (public[0], public[1], private[0], private[1]) #send over private and public keys
...
while True:
    ...
    message_encoded = [str(encrypt(public, char)) for char in message]  # encrypt the message, make string so code.encode works
    [
